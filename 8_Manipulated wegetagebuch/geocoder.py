...
# Eingabedatei
INPUT_CSV_FILE = os.path.join("8_Manipulated wegetagebuch", "wegetagebuch_karlsruhe.csv")
# Ausgabedatei
OUTPUT_CSV_FILE = os.path.join("8_Manipulated wegetagebuch", "wegetagebuch_karlsruhe_koordinaten.csv")
...
def main():
    ...
    print(f"CSV-Datei erfolgreich gespeichert unter: {OUTPUT_CSV_FILE}")
